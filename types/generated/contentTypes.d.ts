...
export interface ApiComunaComuna extends Schema.CollectionType {
...
export interface ApiIntermediariaIntermediaria extends Schema.CollectionType {
  collectionName: 'intermediarias';
  info: {
    singularName: 'intermediaria';
    pluralName: 'intermediarias';
    displayName: 'Intermediaria';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    datos: Attribute.RichText;
    Obs3: Attribute.RichText &
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::intermediaria.intermediaria',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiProveedorProveedor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    FechaUltimaCertificacion: Attribute.Date;
    CertificadoTraslado: Attribute.Media;
    ResolucionFuncionamiento: Attribute.Media;
    NombreContacto: Attribute.String;
    EmailContacto: Attribute.Email;
    NumeroContacto: Attribute.String;
    ZonaCobertura: Attribute.String;
    Descripcion: Attribute.Text;
    Servicios: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSolicitudSolicitud extends Schema.CollectionType {
  ...
  attributes: {
    NombreApellido: Attribute.String & Attribute.Required;
    Email: Attribute.Email & Attribute.Required;
    Telefono: Attribute.String;
    comuna: Attribute.Relation<
...
export interface ApiSucursalSucursal extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Region: Attribute.Enumeration<['Metropolitana']>;
    Comuna: Attribute.Enumeration<['Providencia']>;
    Ciudad: Attribute.Enumeration<['Santiago']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::intermediaria.intermediaria': ApiIntermediariaIntermediaria;
